...
axx_slider = fig.add_axes([0.1, 0.05, 0.25, 0.03])
x_slider = Slider(
    ax=axx_slider,
    label='x-section',
    valmin=0,
...
surfacex = axx.scatter(datax[0], datax[1], c=datax[2], cmap='viridis', alpha = 1)
...
def updatex(val):
    ...
    global surfacex
    surfacex.remove()
    surfacex = axx.scatter(data[0], data[1], c=data[2], cmap='viridis', alpha = 1)
...
axy_slider = fig.add_axes([0.4, 0.05, 0.25, 0.03])
y_slider = Slider(
    ax=axy_slider,
    label='y-section',
    valmin=0,
...
surfacey = axy.scatter(datay[0], datay[1], c=datay[2], cmap='viridis', alpha = 1)
...
def updatey(val):
    ...
    global surfacey
    surfacey.remove()
    surfacey = axy.scatter(data[0], data[1], c=data[2], cmap='viridis', alpha = 1)
...
axz_slider = fig.add_axes([0.7, 0.05, 0.25, 0.03])
z_slider = Slider(
    ax=axz_slider,
    label='z-section',
    valmin=0,
...
surfacez = axz.scatter(dataz[0], dataz[1], c=dataz[2], cmap='viridis', alpha = 1)
...
def updatez(val):
    ...
    global surfacez
    surfacez.remove()
    surfacez = axz.scatter(data[0], data[1], c=data[2], cmap='viridis', alpha = 1)
