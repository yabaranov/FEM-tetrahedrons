...
double derivativeX(std::function<double(const std::array<double, SIZE_NODE>&)> function, const std::array<double, SIZE_NODE>& args, double h)
{
...
double derivativeY(std::function<double(const std::array<double, SIZE_NODE>&)> function, const std::array<double, SIZE_NODE>& args, double h)
{
...
double derivativeZ(std::function<double(const std::array<double, SIZE_NODE>&)> function, const std::array<double, SIZE_NODE>& args, double h)
{
...
double secondDerivativeX(std::function<double(const std::array<double, SIZE_NODE>&)> function, const std::array<double, SIZE_NODE>& args, double h)
{
	std::array<double, SIZE_NODE> xPlush = args;
	xPlush[0] += h;
	std::array<double, SIZE_NODE> xMinush = args;
...
double secondDerivativeY(std::function<double(const std::array<double, SIZE_NODE>&)> function, const std::array<double, SIZE_NODE>& args, double h)
{
...
double secondDerivativeZ(std::function<double(const std::array<double, SIZE_NODE>&)> function, const std::array<double, SIZE_NODE>& args, double h)
{
	std::array<double, SIZE_NODE> zPlush = args;
	zPlush[2] += h;
	std::array<double, SIZE_NODE> zMinush = args;
